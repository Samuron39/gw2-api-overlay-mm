...
**DPS-måler (live).** Et eget overlay-vindu «DPS-måler» (slås på under Overlay-vinduer på Live-fanen) regner DPS fra broen i sanntid: DPS nå (siste 10 s), kampens snitt, totalt, mottatt skade, målet og de største skillene med andel. Utenfor kamp viser det forrige kamp. Kampen starter og slutter med spillets egen kampstatus. Det samme står øverst på DPS-fanen. Trenger ingen loggfiler, og virker mot vanlige fiender i åpen verden, i motsetning til ArcDPS-loggene som bare lagres for bosser.
