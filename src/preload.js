...
const INVOKE = new Set([
  ...
  'live:get', 'live:detail', 'live:record', 'live:resetSession', 'overlays:get', 'overlays:set', 'overlays:ignoreMouse', 'skills:get', 'skills:setRotation', 'skills:suggest', 'skills:icons',
